...
<head>
    <meta charset="UTF-8">
    <title>Mis Cursos - Formación Académica JB</title>
    <style>
        body {
        ...
        .cronograma { display: flex; flex-direction: column; gap: 20px; }
        
        .evento-tarjeta {
            background: <?php echo $usuario['modo_oscuro'] ? '#1f1f1f' : '#ffffff'; ?>;
            border-left: 8px solid #1a426e;
            padding: 20px;
            border-radius: 8px;
            box-shadow: 0 4px 10px rgba(0,0,0,0.05);
            display: flex;
        ...
        .evento-matematica { border-left-color: #2196F3; }
        .evento-fisica { border-left-color: #9C27B0; }
        .evento-quimica { border-left-color: #4CAF50; }
        .evento-aeronautica { border-left-color: #FF9800; }
        .evento-informatica { border-left-color: #00BCD4; }
        ...
        body[style*="background-color: #121212"] .info-bloque h3 { color: #4fc3f7; }
...
<div class="contenedor">
    <div style="margin-bottom: 15px; font-size: 14px; color: <?php echo $usuario['modo_oscuro'] ? '#ccc' : '#334155'; ?>;">
        ...
        <span style="color: <?php echo $usuario['modo_oscuro'] ? '#fff' : '#334155'; ?>; font-weight: bold;">Mis Cursos</span>
    </div>
    <div class="encabezado">
        <h2 style="margin: 0 0 10px 0; color: #1a426e;">Mis Cursos Disponibles</h2>
        <p style="margin: 0; color: #555; font-size: 16px;">Selecciona la asignatura que deseas cursar hoy para ingresar al aula virtual de aprendizaje interactivo.</p>
    </div>

    <div class="cronograma">
        
        <!-- Materia 1 -->
        <a href="curso.php?materia=matematica" class="evento-tarjeta evento-matematica">
            <div class="fecha-bloque" style="background-color: #2196F3;">01 <span>MAT</span></div>
            <?php if ($usuario['pictogramas_activos'] == 1): ?><div class="picto-evento">📐</div><?php endif; ?>
            <div class="info-bloque">
                <h3>Matemáticas Básicas</h3>
                <p>Aprende fracciones y divisiones sencillas estructuradas con apoyo de imágenes.</p>
            </div>
        </a>

        <!-- Materia 2 -->
        <a href="curso.php?materia=fisica" class="evento-tarjeta evento-fisica">
            <div class="fecha-bloque" style="background-color: #9C27B0;">02 <span>FIS</span></div>
            <?php if ($usuario['pictogramas_activos'] == 1): ?><div class="picto-evento">⚛️</div><?php endif; ?>
            <div class="info-bloque">
                <h3>Física Fundamental</h3>
                <p>Descubre los secretos del movimiento continuo y la fuerza invisible de la gravedad.</p>
            </div>
        </a>

        <!-- Materia 3 -->
        <a href="curso.php?materia=quimica" class="evento-tarjeta evento-quimica">
            <div class="fecha-bloque" style="background-color: #4CAF50;">03 <span>QUI</span></div>
            <?php if ($usuario['pictogramas_activos'] == 1): ?><div class="picto-evento">🧪</div><?php endif; ?>
            <div class="info-bloque">
                <h3>Química General</h3>
                <p>Explora de manera guiada los diferentes estados de la materia y sus transformaciones.</p>
            </div>
        </a>

        <!-- Materia 4 -->
        <a href="curso.php?materia=aeronautica" class="evento-tarjeta evento-aeronautica">
            <div class="fecha-bloque" style="background-color: #FF9800;">04 <span>AER</span></div>
            <?php if ($usuario['pictogramas_activos'] == 1): ?><div class="picto-evento">✈️</div><?php endif; ?>
            <div class="info-bloque">
                <h3>Introducción a la Aeronáutica</h3>
                <p>Descubre los principios físicos y de sustentación que permiten volar a los aviones.</p>
            </div>
        </a>

        <!-- Materia 5 -->
        <a href="curso.php?materia=informatica" class="evento-tarjeta evento-informatica">
            <div class="fecha-bloque" style="background-color: #00BCD4;">05 <span>INF</span></div>
            <?php if ($usuario['pictogramas_activos'] == 1): ?><div class="picto-evento">💻</div><?php endif; ?>
            <div class="info-bloque">
                <h3>Informática y Algoritmos</h3>
                <p>Comprende mediante analogías simples cómo procesa las órdenes una computadora.</p>
            </div>
        </a>
